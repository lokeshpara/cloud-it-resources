          ...
          <div className={styles.contact}>
            ...
            <address>
              <div className={styles.contactItem}>
                ...
                <div>
                  <p>13237 Cool Meadow Dr</p>
                  <p>Frisco, Texas – 75035 </p>
                </div>
              </div>
              <div className={styles.contactItem}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div>
                  <p>Email: sram@clouditresourcesllc.com</p>
                </div>
              </div>
              <div className={styles.contactItem}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div>
                  <p>Main: <a href="tel:+14083862233" className={styles.phoneLink}>408-386-2233</a></p>
                </div>
              </div>
            </address>
          </div>
