...
import { FaAward, FaUsers, FaGlobe, FaRocket, FaHandshake, FaLightbulb, FaAws, FaCloud, FaCloudversify } from 'react-icons/fa';
            ...
            >
              ...
              >
                <div className={styles.certificationIcon}>
                  <FaAws className={styles.cloudIcon} size={48} />
                  <span>AWS</span>
                  <span className={styles.cloudDescription}>Support</span>
                </div>
                <div className={styles.certificationIcon}>
                  <FaCloud className={styles.cloudIcon} size={48} />
                  <span>Azure</span>
                  <span className={styles.cloudDescription}>Support</span>
                </div>
                <div className={styles.certificationIcon}>
                  <FaCloudversify className={styles.cloudIcon} size={48} />
                  <span>GCP</span>
                  <span className={styles.cloudDescription}>Support</span>
                </div>
              </motion.div>
